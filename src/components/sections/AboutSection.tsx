      ...
      <div className="section-container relative z-10">
          ...
          <div className="max-w-3xl mx-auto mb-16">
            <div className="pl-6 border-l-2 border-accent-blue/50">
              <p className="text-lg text-text-secondary leading-relaxed">
                I&rsquo;m a Consultant/Lead based in Pune, working at Suma Soft
                Pvt. Ltd. I help teams build platforms that must remain correct
                and usable at scale&mdash;across stakeholders, standards, and
        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative">
            {/* Connecting line */}
            <div className="absolute left-6 top-0 bottom-0 w-px bg-gradient-to-b from-accent-blue via-accent-teal to-accent-blue/20 hidden md:block" />
