      ...
      <div className="section-container relative z-10 py-32 md:py-40">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            className="mt-4 text-lg md:text-xl font-mono text-text-secondary"
          >
            Consultant/Lead
          </motion.p>
          ...
          >
            {specialties.map((specialty, i) => (
              <motion.span
                ...
                className="px-4 py-1.5 text-sm font-mono rounded-full border border-accent-blue/30 text-accent-blue bg-accent-blue/5"
              >
                {specialty}
              </motion.span>
            ))}
          ...
          >
            ...
            <a
              ...
              className="px-8 py-3.5 rounded-full font-semibold text-sm border border-border text-text-secondary hover:border-accent-blue/50 hover:text-text-primary transition-all duration-300"
            >
              Explore my work
            </a>
          </motion.div>
